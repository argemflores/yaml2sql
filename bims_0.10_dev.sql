...
alter table "master"."family"
  ...
  primary key ("id");
alter table "master"."family"
  add constraint "family_creator_id_fkey"
  foreign key ("creator_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;
alter table "master"."family"
  add constraint "family_modifier_id_fkey"
  foreign key ("modifier_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;
...
alter table "master"."audit"
  add constraint "audit_actor_id_fkey"
  foreign key ("actor_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;
alter table "master"."audit"
  add constraint "audit_id_pkey"
  primary key ("id");
alter table "master"."audit"
  add constraint "audit_creator_id_fkey"
  foreign key ("creator_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;
alter table "master"."audit"
  add constraint "audit_modifier_id_fkey"
  foreign key ("modifier_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;
...
create index "transaction_type_idx"
  ...
  using btree ("type");
create index "transaction_actor_id_idx"
  on "warehouse_terminal"."transaction"
  using btree ("actor_id");
create index "transaction_is_successful_idx"
  on "warehouse_terminal"."transaction"
  using btree ("is_successful");
create index "transaction_transferer_id_idx"
  on "warehouse_terminal"."transaction"
  using btree ("transferer_id");
...
create table "warehouse_terminal"."transaction_file" (
    "id" serial not null,
...
alter table "warehouse_terminal"."transaction_file"
  add constraint "transaction_file_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."transaction_file"
  add constraint "transaction_file_id_pkey"
  primary key ("id");
alter table "warehouse_terminal"."transaction_file"
  add constraint "transaction_file_creator_id_fkey"
  foreign key ("creator_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."transaction_file"
  add constraint "transaction_file_modifier_id_fkey"
  foreign key ("modifier_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;

create index "transaction_file_transaction_id_fkey"
  on "warehouse_terminal"."transaction_file"
  using btree ("transaction_id");
create index "transaction_file_is_void_idx"
  on "warehouse_terminal"."transaction_file"
  using btree ("is_void");

-- ----------------

create table "warehouse_terminal"."study" (
    "id" serial not null,
    "transaction_id" integer not null,
...
alter table "warehouse_terminal"."study"
  add constraint "study_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."study"
  add constraint "study_id_pkey"
...
create index "study_transaction_id_idx"
  on "warehouse_terminal"."study"
  using btree ("transaction_id");
create index "study_program_name_idx"
  on "warehouse_terminal"."study"
  using btree ("program_name");
create index "study_place_name_idx"
  on "warehouse_terminal"."study"
  using btree ("place_name");
create index "study_phase_name_idx"
  on "warehouse_terminal"."study"
  using btree ("phase_name");
create index "study_year_idx"
  on "warehouse_terminal"."study"
  using btree ("year");
create index "study_season_idx"
  on "warehouse_terminal"."study"
  using btree ("season");
create index "study_name_idx"
  on "warehouse_terminal"."study"
...
create table "warehouse_terminal"."study_metadata" (
    "id" serial not null,
    "transaction_id" integer not null,
    "study_id" integer not null,
    "variable_id" integer not null,
...
alter table "warehouse_terminal"."study_metadata"
  add constraint "study_metadata_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."study_metadata"
  add constraint "study_metadata_study_id_fkey"
  foreign key ("study_id") references "warehouse_terminal"."study" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."study_metadata"
  add constraint "study_metadata_variable_id_fkey"
  foreign key ("variable_id") references "master"."variable" ("id")
...
create index "study_metadata_transaction_id_idx"
  on "warehouse_terminal"."study_metadata"
  using btree ("transaction_id");
create index "study_metadata_study_id_idx"
  on "warehouse_terminal"."study_metadata"
  using btree ("study_id");
...
create table "warehouse_terminal"."study_variable" (
    "id" serial not null,
    "transaction_id" integer not null,
    "study_id" integer not null,
    "data_level" varchar not null,
...
alter table "warehouse_terminal"."study_variable"
  add constraint "study_variable_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."study_variable"
  add constraint "study_variable_study_id_fkey"
  foreign key ("study_id") references "warehouse_terminal"."study" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."study_variable"
  add constraint "study_variable_variable_id_fkey"
  foreign key ("variable_id") references "master"."variable" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."study_variable"
  add constraint "study_variable_id_pkey"
  primary key ("id");
alter table "warehouse_terminal"."study_variable"
  add constraint "study_variable_creator_id_fkey"
  foreign key ("creator_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."study_variable"
  add constraint "study_variable_modifier_id_fkey"
  foreign key ("modifier_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;

create index "study_variable_transaction_id_idx"
  on "warehouse_terminal"."study_variable"
  using btree ("transaction_id");
create index "study_variable_study_id_idx"
  on "warehouse_terminal"."study_variable"
  using btree ("study_id");
create index "study_variable_variable_id_idx"
  on "warehouse_terminal"."study_variable"
  using btree ("variable_id");
create index "study_variable_is_void_idx"
  on "warehouse_terminal"."study_variable"
  using btree ("is_void");

-- ----------------

create table "warehouse_terminal"."entry" (
    "id" serial not null,
    "transaction_id" integer not null,
    "study_id" integer not null,
...
alter table "warehouse_terminal"."entry"
  add constraint "entry_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."entry"
  add constraint "entry_study_id_fkey"
...
create index "entry_transaction_id_idx"
...
create table "warehouse_terminal"."entry_metadata" (
    "id" serial not null,
    "transaction_id" integer not null,
    "study_id" integer not null,
    "entry_id" integer not null,
...
alter table "warehouse_terminal"."entry_metadata"
  add constraint "entry_metadata_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."entry_metadata"
  add constraint "entry_metadata_study_id_fkey"
...
alter table "warehouse_terminal"."entry_metadata"
  add constraint "entry_metadata_entry_id_fkey"
  foreign key ("entry_id") references "warehouse_terminal"."entry" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."entry_metadata"
  add constraint "entry_metadata_variable_id_fkey"
  foreign key ("variable_id") references "master"."variable" ("id")
...
create index "entry_metadata_transaction_id_idx"
  on "warehouse_terminal"."entry_metadata"
  using btree ("transaction_id");
create index "entry_metadata_study_id_idx"
  on "warehouse_terminal"."entry_metadata"
  using btree ("study_id");
...
create table "warehouse_terminal"."entry_data" (
    "id" serial not null,
    "transaction_id" integer not null,
    "study_id" integer not null,
    "entry_id" integer not null,
...
alter table "warehouse_terminal"."entry_data"
  add constraint "entry_data_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."entry_data"
  add constraint "entry_data_study_id_fkey"
...
create index "entry_data_transaction_id_idx"
  on "warehouse_terminal"."entry_data"
  using btree ("transaction_id");
create index "entry_data_study_id_idx"
  on "warehouse_terminal"."entry_data"
  using btree ("study_id");
...
create table "warehouse_terminal"."entry_summary" (
    "id" serial not null,
    "transaction_id" integer not null,
    "trait" varchar,
...
alter table "warehouse_terminal"."entry_summary"
  add constraint "entry_summary_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."entry_summary"
  add constraint "entry_summary_id_pkey"
  primary key ("id");
alter table "warehouse_terminal"."entry_summary"
  add constraint "entry_summary_creator_id_fkey"
  foreign key ("creator_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."entry_summary"
  add constraint "entry_summary_modifier_id_fkey"
  foreign key ("modifier_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;

create index "entry_summary_transaction_id_idx"
  on "warehouse_terminal"."entry_summary"
  using btree ("transaction_id");
create index "entry_summary_study_name_idx"
  on "warehouse_terminal"."entry_summary"
  using btree ("study_name");
create index "entry_summary_is_void_idx"
  on "warehouse_terminal"."entry_summary"
  using btree ("is_void");

-- ----------------

create table "warehouse_terminal"."plot" (
    "id" serial not null,
    "transaction_id" integer not null,
    "study_id" integer not null,
    "study_name" varchar not null,
...
alter table "warehouse_terminal"."plot"
  add constraint "plot_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."plot"
  add constraint "plot_study_id_fkey"
...
create index "plot_transaction_id_idx"
...
create table "warehouse_terminal"."plot_metadata" (
    "id" serial not null,
    "transaction_id" integer not null,
    "study_id" integer not null,
    "entry_id" integer not null,
...
alter table "warehouse_terminal"."plot_metadata"
  add constraint "plot_metadata_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."plot_metadata"
  add constraint "plot_metadata_study_id_fkey"
...
alter table "warehouse_terminal"."plot_metadata"
  add constraint "plot_metadata_plot_id_fkey"
  foreign key ("plot_id") references "warehouse_terminal"."plot" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."plot_metadata"
  add constraint "plot_metadata_variable_id_fkey"
  foreign key ("variable_id") references "master"."variable" ("id")
...
create index "plot_metadata_transaction_id_idx"
  on "warehouse_terminal"."plot_metadata"
  using btree ("transaction_id");
create index "plot_metadata_study_id_idx"
  on "warehouse_terminal"."plot_metadata"
  using btree ("study_id");
...
create table "warehouse_terminal"."plot_data" (
    "id" serial not null,
    "transaction_id" integer not null,
    "study_id" integer not null,
    "entry_id" integer not null,
...
alter table "warehouse_terminal"."plot_data"
  add constraint "plot_data_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."plot_data"
  add constraint "plot_data_study_id_fkey"
...
create index "plot_data_transaction_id_idx"
  on "warehouse_terminal"."plot_data"
  using btree ("transaction_id");
create index "plot_data_study_id_idx"
  on "warehouse_terminal"."plot_data"
  using btree ("study_id");
...
create table "warehouse_terminal"."plot_summary" (
    "id" serial not null,
    "transaction_id" integer not null,
    "trait" varchar,
    "observations" varchar,
...
alter table "warehouse_terminal"."plot_summary"
  add constraint "plot_summary_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."plot_summary"
  add constraint "plot_summary_id_pkey"
  primary key ("id");
alter table "warehouse_terminal"."plot_summary"
  add constraint "plot_summary_creator_id_fkey"
  foreign key ("creator_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."plot_summary"
  add constraint "plot_summary_modifier_id_fkey"
  foreign key ("modifier_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;

create index "plot_summary_transaction_id_idx"
  on "warehouse_terminal"."plot_summary"
  using btree ("transaction_id");
create index "plot_summary_study_name_idx"
  on "warehouse_terminal"."plot_summary"
  using btree ("study_name");
create index "plot_summary_is_void_idx"
  on "warehouse_terminal"."plot_summary"
  using btree ("is_void");

-- ----------------

create table "warehouse_terminal"."temporary_data_upload" (
    "id" serial not null,
    "transaction_id" integer not null,
...
alter table "warehouse_terminal"."temporary_data_upload"
  add constraint "temporary_data_upload_transaction_id_fkey"
  foreign key ("transaction_id") references "warehouse_terminal"."transaction" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."temporary_data_upload"
  add constraint "temporary_data_upload_user_id_fkey"
  foreign key ("user_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."temporary_data_upload"
  add constraint "temporary_data_upload_id_pkey"
  primary key ("id");
alter table "warehouse_terminal"."temporary_data_upload"
  add constraint "temporary_data_upload_creator_id_fkey"
  foreign key ("creator_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;
alter table "warehouse_terminal"."temporary_data_upload"
  add constraint "temporary_data_upload_modifier_id_fkey"
  foreign key ("modifier_id") references "master"."user" ("id")
  match simple on update cascade on delete cascade;

create index "temporary_data_upload_transaction_id_idx"
  on "warehouse_terminal"."temporary_data_upload"
  using btree ("transaction_id");
create index "temporary_data_upload_user_id_idx"
  on "warehouse_terminal"."temporary_data_upload"
  using btree ("user_id");
create index "temporary_data_upload_is_void_idx"
  on "warehouse_terminal"."temporary_data_upload"
  using btree ("is_void");
...
comment on column "master"."family"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "master"."family"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "master"."family"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "master"."family"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "master"."family"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on index "master"."family_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "family_creator_id_fkey" on "master"."family"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "family_modifier_id_fkey" on "master"."family"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';
...
comment on column "master"."role"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "master"."role"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "master"."role"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "master"."role"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "master"."role"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on index "master"."role_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "role_creator_id_fkey" on "master"."role"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "role_modifier_id_fkey" on "master"."role"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "master"."role_is_void_idx"
  is 'Index for the is_void column';
...
comment on column "master"."item"."creation_timestamp"
  is 'Timestamp when the record was added to the table';

comment on column "master"."item"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "master"."item"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "master"."item"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "master"."item"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "master"."item"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on index "master"."item_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "item_creator_id_fkey" on "master"."item"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "item_modifier_id_fkey" on "master"."item"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "master"."item_abbrev_idx"
  is 'Unique index for the abbrev column';

comment on index "master"."item_is_void_idx"
  is 'Index for the is_void column';
...
comment on column "master"."item_relation"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "master"."item_relation"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "master"."item_relation"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "master"."item_relation"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "master"."item_relation"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on index "master"."item_relation_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "item_relation_creator_id_fkey" on "master"."item_relation"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "item_relation_modifier_id_fkey" on "master"."item_relation"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';
...
comment on column "master"."item_action"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "master"."item_action"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "master"."item_action"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "master"."item_action"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "master"."item_action"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on index "master"."item_action_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "item_action_creator_id_fkey" on "master"."item_action"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "item_action_modifier_id_fkey" on "master"."item_action"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';
...
comment on column "master"."user_item"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "master"."user_item"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "master"."user_item"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "master"."user_item"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "master"."user_item"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "user_item_user_id_fkey" on "master"."user_item"
  is 'Foreign key constraint for the user_id column, which refers to the id column of the master.user table';

comment on index "master"."user_item_user_id_idx"
  is 'Index for the user_id column';
...
comment on column "master"."user_role"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "master"."user_role"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "master"."user_role"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "master"."user_role"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "master"."user_role"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "user_role_user_id_fkey" on "master"."user_role"
  is 'Foreign key constraint for the user_id column, which refers to the id column of the master.user table';

comment on index "master"."user_role_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "user_role_creator_id_fkey" on "master"."user_role"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "user_role_modifier_id_fkey" on "master"."user_role"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "master"."user_role_user_id_idx"
  is 'Index for the user_id column';
...
comment on column "master"."user_session"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "master"."user_session"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "master"."user_session"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "master"."user_session"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "master"."user_session"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "user_session_user_id_fkey" on "master"."user_session"
  is 'Foreign key constraint for the user_id column, which refers to the id column of the master.user table';

comment on index "master"."user_session_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "user_session_creator_id_fkey" on "master"."user_session"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "user_session_modifier_id_fkey" on "master"."user_session"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "master"."user_session_user_id_idx"
  is 'Index for the user_id column';
...
comment on column "master"."team_member"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "master"."team_member"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "master"."team_member"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "master"."team_member"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "master"."team_member"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on index "master"."team_member_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "team_member_creator_id_fkey" on "master"."team_member"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "team_member_modifier_id_fkey" on "master"."team_member"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';
...
comment on schema "warehouse_terminal"
  is 'Terminal to warehouse data';

comment on table "warehouse_terminal"."transaction"
...
comment on column "warehouse_terminal"."transaction"."actor_id"
  is 'User who performed the upload or commit action';

comment on column "warehouse_terminal"."transaction"."start_action_timestamp"
  is 'Timestamp when the action started; starts from upload, reading contents, initial data validation, to saving to data warehouse terminal tables (study-, entry-, plot-level data)';

comment on column "warehouse_terminal"."transaction"."end_action_timestamp"
  is 'Timestamp when the action ended; starts from upload, reading contents, initial data validation, to saving to data warehouse terminal tables (study-, entry-, plot-level data)';

comment on column "warehouse_terminal"."transaction"."total_file_count"
  is 'Total number of files uploaded or committed';

comment on column "warehouse_terminal"."transaction"."successful_file_count"
  is 'Number of files that were successfully uploaded to data warehouse terminal or committed to data warehouse';
...
comment on column "warehouse_terminal"."transaction"."creation_timestamp"
  is 'Timestamp when the record was added to the table';

comment on column "warehouse_terminal"."transaction"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."transaction"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."transaction"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."transaction"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."transaction"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on index "warehouse_terminal"."transaction_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "transaction_creator_id_fkey" on "warehouse_terminal"."transaction"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "transaction_modifier_id_fkey" on "warehouse_terminal"."transaction"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."transaction_is_void_idx"
  is 'Index for the is_void column';

comment on table "warehouse_terminal"."transaction_file"
...
comment on column "warehouse_terminal"."transaction_file"."data_level"
  is 'Data level where the file is supposed to be inserted to.
Possible values are study, entry, or plot.';

comment on column "warehouse_terminal"."transaction_file"."name"
  is 'Name of the file';

comment on column "warehouse_terminal"."transaction_file"."extension"
  is 'Extension of the file';

comment on column "warehouse_terminal"."transaction_file"."type"
  is 'Mimetype of the file';

comment on column "warehouse_terminal"."transaction_file"."size"
  is 'Size of the file in bytes';

comment on column "warehouse_terminal"."transaction_file"."contents"
  is 'Contents of the file';

comment on column "warehouse_terminal"."transaction_file"."remarks"
  is 'Additional details';

comment on column "warehouse_terminal"."transaction_file"."creation_timestamp"
  is 'Timestamp when the record was added to the table';

comment on column "warehouse_terminal"."transaction_file"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."transaction_file"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."transaction_file"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."transaction_file"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."transaction_file"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on index "warehouse_terminal"."transaction_file_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "transaction_file_creator_id_fkey" on "warehouse_terminal"."transaction_file"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "transaction_file_modifier_id_fkey" on "warehouse_terminal"."transaction_file"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."transaction_file_is_void_idx"
  is 'Index for the is_void column';

comment on table "warehouse_terminal"."study"
  is 'Studies';
...
comment on column "warehouse_terminal"."study"."program_name"
  is 'Abbreviation of the program where the study belongs to';

comment on column "warehouse_terminal"."study"."place_name"
  is 'Abbreviation of the place where the study is conducted';

comment on column "warehouse_terminal"."study"."phase_name"
  is 'Abbreviation of the breeding stage or special experiment of the study (collectively referred to as phase)';

comment on column "warehouse_terminal"."study"."year"
  is 'Year when the study was conducted';

comment on column "warehouse_terminal"."study"."season"
  is 'Abbreviation of the season when the study is conducted';

comment on column "warehouse_terminal"."study"."name"
  is 'Historical name of the study';

comment on column "warehouse_terminal"."study"."remarks"
  is 'Additional details';

comment on column "warehouse_terminal"."study"."creation_timestamp"
  is 'Timestamp when the record was added to the table';

comment on column "warehouse_terminal"."study"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."study"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."study"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."study"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."study"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "study_transaction_id_fkey" on "warehouse_terminal"."study"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on index "warehouse_terminal"."study_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "study_creator_id_fkey" on "warehouse_terminal"."study"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "study_modifier_id_fkey" on "warehouse_terminal"."study"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."study_transaction_id_idx"
  is 'Index for the transaction_id column';

comment on index "warehouse_terminal"."study_is_void_idx"
  is 'Index for the is_void column';

comment on table "warehouse_terminal"."study_metadata"
  is 'Metadata of a study';
...
comment on column "warehouse_terminal"."study_metadata"."remarks"
  is 'Additional details';

comment on column "warehouse_terminal"."study_metadata"."creation_timestamp"
  is 'Timestamp when the record was added to the table';

comment on column "warehouse_terminal"."study_metadata"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."study_metadata"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."study_metadata"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."study_metadata"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."study_metadata"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "study_metadata_transaction_id_fkey" on "warehouse_terminal"."study_metadata"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on constraint "study_metadata_study_id_fkey" on "warehouse_terminal"."study_metadata"
  is 'Foreign key constraint for the study_id column, which refers to the id column of the study table';

comment on constraint "study_metadata_variable_id_fkey" on "warehouse_terminal"."study_metadata"
  is 'Foreign key constraint for the variable_id column, which refers to the id column of the master.variable table';

comment on index "warehouse_terminal"."study_metadata_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "study_metadata_creator_id_fkey" on "warehouse_terminal"."study_metadata"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "study_metadata_modifier_id_fkey" on "warehouse_terminal"."study_metadata"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."study_metadata_transaction_id_idx"
  is 'Index for the transaction_id column';

comment on index "warehouse_terminal"."study_metadata_study_id_idx"
  is 'Index for the study_id column';

comment on index "warehouse_terminal"."study_metadata_variable_id_idx"
  is 'Index for the variable_id column';

comment on index "warehouse_terminal"."study_metadata_is_void_idx"
  is 'Index for the is_void column';

comment on table "warehouse_terminal"."study_variable"
...
comment on column "warehouse_terminal"."study_variable"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."study_variable"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."study_variable"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."study_variable"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."study_variable"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "study_variable_transaction_id_fkey" on "warehouse_terminal"."study_variable"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on constraint "study_variable_study_id_fkey" on "warehouse_terminal"."study_variable"
  is 'Foreign key constraint for the study_id column, which refers to the id column of the study table';

comment on constraint "study_variable_variable_id_fkey" on "warehouse_terminal"."study_variable"
  is 'Foreign key constraint for the variable_id column, which refers to the id column of the master.variable table';

comment on index "warehouse_terminal"."study_variable_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "study_variable_creator_id_fkey" on "warehouse_terminal"."study_variable"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "study_variable_modifier_id_fkey" on "warehouse_terminal"."study_variable"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."study_variable_transaction_id_idx"
  is 'Index for the transaction_id column';

comment on index "warehouse_terminal"."study_variable_study_id_idx"
  is 'Index for the study_id column';

comment on index "warehouse_terminal"."study_variable_variable_id_idx"
  is 'Index for the variable_id column';

comment on index "warehouse_terminal"."study_variable_is_void_idx"
  is 'Index for the is_void column';

comment on table "warehouse_terminal"."entry"
  is 'Entries of a study';
...
comment on column "warehouse_terminal"."entry"."seed_source_name"
  is 'Source of seeds';

comment on column "warehouse_terminal"."entry"."remarks"
  is 'Additional details';

comment on column "warehouse_terminal"."entry"."creation_timestamp"
  is 'Timestamp when the record was added to the table';

comment on column "warehouse_terminal"."entry"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."entry"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."entry"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."entry"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."entry"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "entry_transaction_id_fkey" on "warehouse_terminal"."entry"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on constraint "entry_study_id_fkey" on "warehouse_terminal"."entry"
  is 'Foreign key constraint for the study_id column, which refers to the id column of the study table';

comment on index "warehouse_terminal"."entry_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "entry_creator_id_fkey" on "warehouse_terminal"."entry"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "entry_modifier_id_fkey" on "warehouse_terminal"."entry"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."entry_transaction_id_idx"
  is 'Index for the transaction_id column';

comment on index "warehouse_terminal"."entry_study_id_idx"
  is 'Index for the study_id column';

comment on index "warehouse_terminal"."entry_is_void_idx"
  is 'Index for the is_void column';
...
comment on column "warehouse_terminal"."entry_metadata"."remarks"
  is 'Additional details';

comment on column "warehouse_terminal"."entry_metadata"."creation_timestamp"
  is 'Timestamp when the record was added to the table';

comment on column "warehouse_terminal"."entry_metadata"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."entry_metadata"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."entry_metadata"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."entry_metadata"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."entry_metadata"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "entry_metadata_transaction_id_fkey" on "warehouse_terminal"."entry_metadata"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on constraint "entry_metadata_study_id_fkey" on "warehouse_terminal"."entry_metadata"
  is 'Foreign key constraint for the study_id column, which refers to the id column of the study table';

comment on constraint "entry_metadata_entry_id_fkey" on "warehouse_terminal"."entry_metadata"
  is 'Foreign key constraint for the entry_id column, which refers to the id column of the entry table';

comment on constraint "entry_metadata_variable_id_fkey" on "warehouse_terminal"."entry_metadata"
  is 'Foreign key constraint for the variable_id column, which refers to the id column of the master.variable table';

comment on index "warehouse_terminal"."entry_metadata_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "entry_metadata_creator_id_fkey" on "warehouse_terminal"."entry_metadata"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "entry_metadata_modifier_id_fkey" on "warehouse_terminal"."entry_metadata"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."entry_metadata_transaction_id_idx"
  is 'Index for the transaction_id column';

comment on index "warehouse_terminal"."entry_metadata_study_id_idx"
  is 'Index for the study_id column';

comment on index "warehouse_terminal"."entry_metadata_entry_id_idx"
  is 'Index for the entry_id column';

comment on index "warehouse_terminal"."entry_metadata_variable_id_idx"
  is 'Index for the variable_id column';

comment on index "warehouse_terminal"."entry_metadata_is_void_idx"
  is 'Index for the is_void column';
...
comment on column "warehouse_terminal"."entry_data"."remarks"
  is 'Additional details';

comment on column "warehouse_terminal"."entry_data"."creation_timestamp"
  is 'Timestamp when the record was added to the table';

comment on column "warehouse_terminal"."entry_data"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."entry_data"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."entry_data"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."entry_data"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."entry_data"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "entry_data_transaction_id_fkey" on "warehouse_terminal"."entry_data"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on constraint "entry_data_study_id_fkey" on "warehouse_terminal"."entry_data"
  is 'Foreign key constraint for the study_id column, which refers to the id column of the study table';

comment on constraint "entry_data_entry_id_fkey" on "warehouse_terminal"."entry_data"
  is 'Foreign key constraint for the entry_id column, which refers to the id column of the entry table';

comment on constraint "entry_data_variable_id_fkey" on "warehouse_terminal"."entry_data"
  is 'Foreign key constraint for the variable_id column, which refers to the id column of the master.variable table';

comment on index "warehouse_terminal"."entry_data_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "entry_data_creator_id_fkey" on "warehouse_terminal"."entry_data"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "entry_data_modifier_id_fkey" on "warehouse_terminal"."entry_data"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."entry_data_transaction_id_idx"
  is 'Index for the transaction_id column';

comment on index "warehouse_terminal"."entry_data_study_id_idx"
  is 'Index for the study_id column';

comment on index "warehouse_terminal"."entry_data_entry_id_idx"
  is 'Index for the entry_id column';

comment on index "warehouse_terminal"."entry_data_variable_id_idx"
  is 'Index for the variable_id column';

comment on index "warehouse_terminal"."entry_data_is_void_idx"
  is 'Index for the is_void column';
...
comment on column "warehouse_terminal"."entry_summary"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."entry_summary"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."entry_summary"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."entry_summary"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."entry_summary"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "entry_summary_transaction_id_fkey" on "warehouse_terminal"."entry_summary"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on index "warehouse_terminal"."entry_summary_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "entry_summary_creator_id_fkey" on "warehouse_terminal"."entry_summary"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "entry_summary_modifier_id_fkey" on "warehouse_terminal"."entry_summary"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."entry_summary_transaction_id_idx"
  is 'Index for the transaction_id column';

comment on index "warehouse_terminal"."entry_summary_is_void_idx"
  is 'Index for the is_void column';

comment on table "warehouse_terminal"."plot"
...
comment on column "warehouse_terminal"."plot"."creation_timestamp"
  is 'Timestamp when the record was added to the table';

comment on column "warehouse_terminal"."plot"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."plot"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."plot"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."plot"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."plot"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "plot_transaction_id_fkey" on "warehouse_terminal"."plot"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on constraint "plot_study_id_fkey" on "warehouse_terminal"."plot"
  is 'Foreign key constraint for the study_id column, which refers to the id column of the study table';

comment on index "warehouse_terminal"."plot_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "plot_creator_id_fkey" on "warehouse_terminal"."plot"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "plot_modifier_id_fkey" on "warehouse_terminal"."plot"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."plot_transaction_id_idx"
  is 'Index for the transaction_id column';

comment on index "warehouse_terminal"."plot_study_id_idx"
  is 'Index for the study_id column';

comment on index "warehouse_terminal"."plot_is_void_idx"
  is 'Index for the is_void column';
...
comment on column "warehouse_terminal"."plot_metadata"."remarks"
  is 'Additional details';

comment on column "warehouse_terminal"."plot_metadata"."creation_timestamp"
  is 'Timestamp when the record was added to the table';

comment on column "warehouse_terminal"."plot_metadata"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."plot_metadata"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."plot_metadata"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."plot_metadata"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."plot_metadata"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "plot_metadata_transaction_id_fkey" on "warehouse_terminal"."plot_metadata"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on constraint "plot_metadata_study_id_fkey" on "warehouse_terminal"."plot_metadata"
  is 'Foreign key constraint for the study_id column, which refers to the id column of the study table';

comment on constraint "plot_metadata_entry_id_fkey" on "warehouse_terminal"."plot_metadata"
  is 'Foreign key constraint for the entry_id column, which refers to the id column of the entry table';

comment on constraint "plot_metadata_plot_id_fkey" on "warehouse_terminal"."plot_metadata"
  is 'Foreign key constraint for the plot_id column, which refers to the id column of the plot table';

comment on constraint "plot_metadata_variable_id_fkey" on "warehouse_terminal"."plot_metadata"
  is 'Foreign key constraint for the variable_id column, which refers to the id column of the master.variable table';

comment on index "warehouse_terminal"."plot_metadata_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "plot_metadata_creator_id_fkey" on "warehouse_terminal"."plot_metadata"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "plot_metadata_modifier_id_fkey" on "warehouse_terminal"."plot_metadata"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."plot_metadata_transaction_id_idx"
  is 'Index for the transaction_id column';

comment on index "warehouse_terminal"."plot_metadata_study_id_idx"
  is 'Index for the study_id column';

comment on index "warehouse_terminal"."plot_metadata_entry_id_idx"
  is 'Index for the entry_id column';

comment on index "warehouse_terminal"."plot_metadata_plot_id_idx"
  is 'Index for the plot_id column';

comment on index "warehouse_terminal"."plot_metadata_variable_id_idx"
  is 'Index for the variable_id column';

comment on index "warehouse_terminal"."plot_metadata_is_void_idx"
  is 'Index for the is_void column';
...
comment on column "warehouse_terminal"."plot_data"."remarks"
  is 'Additional details';

comment on column "warehouse_terminal"."plot_data"."creation_timestamp"
  is 'Timestamp when the record was added to the table';

comment on column "warehouse_terminal"."plot_data"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."plot_data"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."plot_data"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."plot_data"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."plot_data"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "plot_data_transaction_id_fkey" on "warehouse_terminal"."plot_data"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on constraint "plot_data_study_id_fkey" on "warehouse_terminal"."plot_data"
  is 'Foreign key constraint for the study_id column, which refers to the id column of the study table';

comment on constraint "plot_data_entry_id_fkey" on "warehouse_terminal"."plot_data"
  is 'Foreign key constraint for the entry_id column, which refers to the id column of the entry table';

comment on constraint "plot_data_plot_id_fkey" on "warehouse_terminal"."plot_data"
  is 'Foreign key constraint for the plot_id column, which refers to the id column of the plot table';

comment on constraint "plot_data_variable_id_fkey" on "warehouse_terminal"."plot_data"
  is 'Foreign key constraint for the variable_id column, which refers to the id column of the master.variable table';

comment on index "warehouse_terminal"."plot_data_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "plot_data_creator_id_fkey" on "warehouse_terminal"."plot_data"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "plot_data_modifier_id_fkey" on "warehouse_terminal"."plot_data"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."plot_data_transaction_id_idx"
  is 'Index for the transaction_id column';

comment on index "warehouse_terminal"."plot_data_study_id_idx"
  is 'Index for the study_id column';

comment on index "warehouse_terminal"."plot_data_entry_id_idx"
  is 'Index for the entry_id column';

comment on index "warehouse_terminal"."plot_data_plot_id_idx"
  is 'Index for the plot_id column';

comment on index "warehouse_terminal"."plot_data_variable_id_idx"
  is 'Index for the variable_id column';

comment on index "warehouse_terminal"."plot_data_is_void_idx"
  is 'Index for the is_void column';
...
comment on column "warehouse_terminal"."plot_summary"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."plot_summary"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."plot_summary"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."plot_summary"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."plot_summary"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "plot_summary_transaction_id_fkey" on "warehouse_terminal"."plot_summary"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on index "warehouse_terminal"."plot_summary_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "plot_summary_creator_id_fkey" on "warehouse_terminal"."plot_summary"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "plot_summary_modifier_id_fkey" on "warehouse_terminal"."plot_summary"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."plot_summary_transaction_id_idx"
  is 'Index for the transaction_id column';
...
comment on column "warehouse_terminal"."temporary_data_upload"."creator_id"
  is 'ID of the user who added the record to the table';

comment on column "warehouse_terminal"."temporary_data_upload"."modification_timestamp"
  is 'Timestamp when the record was last modified';

comment on column "warehouse_terminal"."temporary_data_upload"."modifier_id"
  is 'ID of the user who last modified the record';

comment on column "warehouse_terminal"."temporary_data_upload"."notes"
  is 'Additional details added by an admin; can be technical or advanced details';

comment on column "warehouse_terminal"."temporary_data_upload"."is_void"
  is 'Indicator whether the record is deleted or not';

comment on constraint "temporary_data_upload_transaction_id_fkey" on "warehouse_terminal"."temporary_data_upload"
  is 'Foreign key constraint for the transaction_id column, which refers to the id column of the transaction table';

comment on constraint "temporary_data_upload_user_id_fkey" on "warehouse_terminal"."temporary_data_upload"
  is 'Foreign key constraint for the user_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."temporary_data_upload_id_pkey"
  is 'Primary key constraint for the id column';

comment on constraint "temporary_data_upload_creator_id_fkey" on "warehouse_terminal"."temporary_data_upload"
  is 'Foreign key constraint for the creator_id column, which refers to the id column of master.user table';

comment on constraint "temporary_data_upload_modifier_id_fkey" on "warehouse_terminal"."temporary_data_upload"
  is 'Foreign key constraint for the modifier_id column, which refers to the id column of the master.user table';

comment on index "warehouse_terminal"."temporary_data_upload_transaction_id_idx"
  is 'Index for the transaction_id column';

comment on index "warehouse_terminal"."temporary_data_upload_user_id_idx"
  is 'Index for the user_id column';

comment on index "warehouse_terminal"."temporary_data_upload_is_void_idx"
  is 'Index for the is_void column';
